...
Each item is designed to be completed independently. Migration guides are stored in `archive/migration/` folder with corresponding names.
...
- [x] **SIMPLIFY-001**: Add macros to reduce config boilerplate
  - [migration:SIMPLIFY-001-config-macros](archive/migration/SIMPLIFY-001-config-macros.md)
...
- [x] **SIMPLIFY-002**: Unify torrent control methods
  - [migration:SIMPLIFY-002-torrent-control](archive/migration/SIMPLIFY-002-torrent-control.md)
...
- [x] **SIMPLIFY-013**: Add tracing instrumentation
  - [migration:SIMPLIFY-013-tracing-instrument](archive/migration/SIMPLIFY-013-tracing-instrument.md)
...
- [x] **SIMPLIFY-014**: Create unified request helpers
  - [migration:SIMPLIFY-014-request-helpers](archive/migration/SIMPLIFY-014-request-helpers.md)
...
- [x] **SIMPLIFY-003**: Extract main.rs helpers
  - [migration:SIMPLIFY-003-main-helpers](archive/migration/SIMPLIFY-003-main-helpers.md)
...
- [x] **SIMPLIFY-004**: Add FUSE logging macros
  - [migration:SIMPLIFY-004-fuse-logging](archive/migration/SIMPLIFY-004-fuse-logging.md)
...
- [x] **SIMPLIFY-005**: Add error handler methods
  - [migration:SIMPLIFY-005-error-handlers](archive/migration/SIMPLIFY-005-error-handlers.md)
...
- [x] **SIMPLIFY-006**: Unify torrent discovery
  - [migration:SIMPLIFY-006-torrent-discovery](archive/migration/SIMPLIFY-006-torrent-discovery.md)
...
- [x] **SIMPLIFY-007**: Simplify inode allocation
  - [migration:SIMPLIFY-007-inode-allocation](archive/migration/SIMPLIFY-007-inode-allocation.md)
...
- [x] **SIMPLIFY-008**: Extract ShardedCounter to lib
  - [migration:SIMPLIFY-008-sharded-counter](archive/migration/SIMPLIFY-008-sharded-counter.md)
...
- [x] **SIMPLIFY-009**: Simplify API types
  - [migration:SIMPLIFY-009-api-types](archive/migration/SIMPLIFY-009-api-types.md)
...
- [x] **SIMPLIFY-012**: Consolidate type files
  - [migration:SIMPLIFY-012-type-consolidation](archive/migration/SIMPLIFY-012-type-consolidation.md)
...
- [x] **SIMPLIFY-010**: Add metrics macros and trait
  - [migration:SIMPLIFY-010-metrics-macros](archive/migration/SIMPLIFY-010-metrics-macros.md)
...
- [x] **SIMPLIFY-011**: Extract streaming helpers
  - [migration:SIMPLIFY-011-streaming-helpers](archive/migration/SIMPLIFY-011-streaming-helpers.md)
...
- [migration:SIMPLIFY-001](archive/migration/SIMPLIFY-001-config-macros.md) - Config macros
- [migration:SIMPLIFY-002](archive/migration/SIMPLIFY-002-torrent-control.md) - Torrent control
- [migration:SIMPLIFY-003](archive/migration/SIMPLIFY-003-main-helpers.md) - Main.rs helpers
- [migration:SIMPLIFY-004](archive/migration/SIMPLIFY-004-fuse-logging.md) - FUSE logging
- [migration:SIMPLIFY-005](archive/migration/SIMPLIFY-005-error-handlers.md) - Error handlers
- [migration:SIMPLIFY-006](archive/migration/SIMPLIFY-006-torrent-discovery.md) - Discovery
- [migration:SIMPLIFY-007](archive/migration/SIMPLIFY-007-inode-allocation.md) - Inode allocation
- [migration:SIMPLIFY-008](archive/migration/SIMPLIFY-008-sharded-counter.md) - ShardedCounter
- [migration:SIMPLIFY-009](archive/migration/SIMPLIFY-009-api-types.md) - API types
- [migration:SIMPLIFY-010](archive/migration/SIMPLIFY-010-metrics-macros.md) - Metrics macros
- [migration:SIMPLIFY-011](archive/migration/SIMPLIFY-011-streaming-helpers.md) - Streaming helpers
- [migration:SIMPLIFY-012](archive/migration/SIMPLIFY-012-type-consolidation.md) - Type consolidation
- [migration:SIMPLIFY-013](archive/migration/SIMPLIFY-013-tracing-instrument.md) - Tracing
- [migration:SIMPLIFY-014](archive/migration/SIMPLIFY-014-request-helpers.md) - Request helpers
